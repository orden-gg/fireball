...
export class GraphFiltersHelper {
  ...
  public static getUpdatedInputFromQuery(filter: GraphInputFilter, value: string): GraphInputFilter {
    return {
      ...filter,
      isFilterActive: true,
      value
  ...
  public static getIsRangeSliderFilterValid(
    values: GraphRangeSliderFilterValue,
  ...
  public static getResetedMultipleSelectionFilter(
  ...
  public static getResetedMultipleAutocompleteFilter(
