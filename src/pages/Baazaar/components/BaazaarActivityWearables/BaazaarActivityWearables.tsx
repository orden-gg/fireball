...
export function BaazaarActivityWearables() {
    ...
    const activityWearablesListings: ActivityWearableListingVM[] = useAppSelector(fromBaazaarStore.getActivityWearablesListings);
    const isActivityWearablesListingsInitialDataLoading: boolean =
        useAppSelector(fromBaazaarStore.getIsActivityWearablesListingsInitialDataLoading);
    const isActivityWearablesListingsLoading: boolean = useAppSelector(fromBaazaarStore.getIsActivityWearablesListingsLoading);
    const activityWearablesListingsFilters: ActivityWearableListingFilters =
        useAppSelector(fromBaazaarStore.getActivityWearablesListingsFilters);
    const activityWearablesListingsQueryParamsOrder: string[] = useAppSelector(fromBaazaarStore.getActivityWearablesListingsQueryParamsOrder);

    useEffect(() => {
        const updatedFilters: ActivityWearableListingFilters =
            GraphFiltersUtils.getUpdatedFiltersFromQueryParams(queryParams, { ...activityWearablesListingsFilters });
    ...
    useEffect(() => {
        const params: CustomParsedQuery<GraphFiltersQueryParamTypes> =
            GraphFiltersUtils.getFiltersQueryParams(queryParams, { ...activityWearablesListingsFilters });
    ...
    const onSetSelectedFilters = (key: string, value: GraphFiltersValueTypes) => {
        dispatch(fromBaazaarStore.updateActivityWearablesListingsFilterByKey(
            { key, value } as { key: ActivityWearableListingFilterTypes, value: GraphFiltersValueTypes }
        ));
    };
