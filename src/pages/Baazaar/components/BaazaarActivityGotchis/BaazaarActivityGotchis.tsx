...
export function BaazaarActivityGotchis() {
  ...
  const activityGotchisListings: ActivityGotchiListingVM[] = useAppSelector(
    fromBaazaarStore.getActivityGotchisListings
  );
  const isActivityGotchisListingsInitialDataLoading: boolean = useAppSelector(
    fromBaazaarStore.getIsActivityGotchisListingsInitialDataLoading
  );
  const isActivityGotchisListingsLoading: boolean = useAppSelector(
    fromBaazaarStore.getIsActivityGotchisListingsLoading
  );
  const activityGotchisListingsFilters: ActivityGotchiListingFilters = useAppSelector(
    fromBaazaarStore.getActivityGotchisListingsFilters
  );
  const activityGotchisListingsQueryParamsOrder: string[] = useAppSelector(
    fromBaazaarStore.getActivityGotchisListingsQueryParamsOrder
  );

  useEffect(() => {
    const updatedFilters: ActivityGotchiListingFilters = GraphFiltersUtils.getUpdatedFiltersFromQueryParams(
      queryParams,
  ...
  const onSetSelectedFilters = (key: string, value: GraphFiltersValueTypes) => {
    dispatch(
      fromBaazaarStore.updateActivityGotchisListingsFilterByKey({ key, value } as {
        key: ActivityGotchiListingFilterTypes;
