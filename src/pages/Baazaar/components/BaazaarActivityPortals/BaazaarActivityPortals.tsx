...
export function BaazaarActivityPortals() {
  ...
  const activityPortalsListings: ActivityPortalListingVM[] = useAppSelector(
    fromBaazaarStore.getActivityPortalsListings
  );
  const isActivityPortalsListingsInitialDataLoading: boolean = useAppSelector(
    fromBaazaarStore.getIsActivityPortalsListingsInitialDataLoading
  );
  const isActivityPortalsListingsLoading: boolean = useAppSelector(
    fromBaazaarStore.getIsActivityPortalsListingsLoading
  );
  const activityPortalsListingsFilters: ActivityPortalListingFilters = useAppSelector(
    fromBaazaarStore.getActivityPortalsListingsFilters
  );
  const activityPortalsListingsQueryParamsOrder: string[] = useAppSelector(
    fromBaazaarStore.getActivityPortalsListingsQueryParamsOrder
  );

  useEffect(() => {
    const updatedFilters: ActivityPortalListingFilters = GraphFiltersUtils.getUpdatedFiltersFromQueryParams(
      queryParams,
  ...
  const onSetSelectedFilters = (key: string, value: GraphFiltersValueTypes) => {
    dispatch(
      fromBaazaarStore.updateActivityPortalsListingsFilterByKey({ key, value } as {
        key: ActivityPortalListingFilterTypes;
