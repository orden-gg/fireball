...
export function BaazaarActivityTiles() {
    ...
    const isActivityTilesListingsInitialDataLoading: boolean =
        useAppSelector(fromBaazaarStore.getIsActivityTilesListingsInitialDataLoading);
    const isActivityTilesListingsLoading: boolean = useAppSelector(fromBaazaarStore.getIsActivityTilesListingsLoading);
    const activityTilesListingsFilters: ActivityTileListingFilters =
        useAppSelector(fromBaazaarStore.getActivityTilesListingsFilters);
    const activityTilesListingsQueryParamsOrder: string[] = useAppSelector(fromBaazaarStore.getActivityTilesListingsQueryParamsOrder);

    useEffect(() => {
        const updatedFilters: ActivityTileListingFilters =
            GraphFiltersUtils.getUpdatedFiltersFromQueryParams(queryParams, { ...activityTilesListingsFilters });
    ...
    useEffect(() => {
        const params: CustomParsedQuery<GraphFiltersQueryParamTypes> =
            GraphFiltersUtils.getFiltersQueryParams(queryParams, { ...activityTilesListingsFilters });
    ...
    const onSetSelectedFilters = (key: string, value: GraphFiltersValueTypes) => {
        dispatch(fromBaazaarStore.updateActivityTilesListingsFilterByKey(
            { key, value } as { key: ActivityTileListingFilterTypes, value: GraphFiltersValueTypes }
        ));
    };
