...
export function BaazaarOpenedPortals() {
    ...
    const initialOpenedPortalsListings: OpenedPortalListingVM[] = useAppSelector(fromBaazaarStore.getInitialOpenedPortalsListings);
    ...
    const openedPortalsListingsDefaultSorting: SortingItem = useAppSelector(fromBaazaarStore.getOpenedPortalsListingsDefaultSorting);
    const openedPortalsListingsSorting: SortingItem = useAppSelector(fromBaazaarStore.getOpenedPortalsListingsSorting);
    const openedPortalsListingsQueryParamsOrder: string[] = useAppSelector(fromBaazaarStore.getOpenedPortalsListingsQueryParamsOrder);
    ...
    useEffect(() => {
        ...
        if (sort && dir) {
            const key: Undefinable<string> = openedPortalsListingsSortings
    ...
    useEffect(() => {
        const params: CustomParsedQuery<GraphFiltersQueryParamTypes> = FilterUtils.getUpdatedQueryParams(queryParams, currentFilters);
    ...
    useEffect(() => {
        ...
        const paramKey: Undefinable<string> = openedPortalsListingsSortings
            .find(sorting => sorting.key === openedPortalsListingsSorting.type)?.paramKey;
