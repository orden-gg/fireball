...
export const loadBaazaarActivityGotchisListings = (shouldResetListings: boolean = false): AppThunk => (dispatch, getState) => {
    ...
    const activityGotchisListings: ActivityGotchiListingVM[] = getState().baazaar.activity.gotchis.activityGotchisListings.data;
...
export const updateActivityGotchisListingsFilterByKey =
    ({ key, value }: { key: ActivityGotchiListingFilterTypes, value: GraphFiltersValueTypes }): AppThunk =>
        (dispatch, getState) => {
            ...
            dispatch(setActivityGotchisListingsFilters({ ...filters, [key]: updatedFilter as ActivityGotchiListingFiltersType }));
        };

export const resetActivityGotchisListingsFilters = (): AppThunk =>
    (dispatch, getState) => {
        const filters: ActivityGotchiListingFilters = getState().baazaar.activity.gotchis.activityGotchisListingsFilters;
...
export const resetActivityGotchisData = (): AppThunk =>
    (dispatch, getState) => {
        const filters: ActivityGotchiListingFilters = getState().baazaar.activity.gotchis.activityGotchisListingsFilters;
