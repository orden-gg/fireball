          ...
          {tickets.map((ticket, i) => {
            return (
              <Grid item xs={4} sm={true} key={i}>
                <Box
                  textAlign='center'
                  className={classNames(classes.textHighlight, ticket.rarity, classes.ticketVisual)}
                >
                  {raffleSpinner ? (
      ...
      <Grid container spacing={2} className={classes.row}>
        ...
        <Grid container item spacing={1} xs={12} md={8} lg={9}>
          {tickets.map((ticket: any, i: number) => {
            ...
            return (
              <Grid item xs={4} sm={true} key={i} className={classes.ticketBg}>
            ...
            return (
              <Grid item xs={4} sm={true} key={i} style={{ paddingLeft: 0 }}>
                <Box
                  maxWidth={200}
                  margin='auto'
                  className={classNames(classes.chance, ticket.rarity, ticket.chance !== 0 ? 'highlighted' : '')}
                >
                  <Typography
                    variant='body1'
                    align='center'
