...
export const styles = makeStyles((theme) =>
  createStyles({
    ...
    horizontalCard: {
      ...
      '&.humble': {
        backgroundColor: alpha(theme.palette.realm.humble, 0.15)
      },
      '&.reasonable': {
        backgroundColor: alpha(theme.palette.realm.reasonable, 0.15)
      },
      '&.spacious': {
        backgroundColor: alpha(theme.palette.realm.spacious, 0.15)
      },
      '&.golden': {
    ...
    ticketImageCell: {
      ...
      '.drop &': {
        backgroundColor: alpha(theme.palette.rarity.drop, 0.05)
      }
    },
    ticketInfoCell: {
      display: 'flex',
  ...
  createStyles({
    item: {
      ...
      '&.humble': {
        ...
        '&:hover': {
          backgroundColor: alpha(theme.palette.realm.humble, 0.2)
        }
      },
      '&.reasonable': {
        backgroundColor: alpha(theme.palette.realm.reasonable, 0.15),
        ...
        '&:hover': {
          backgroundColor: alpha(theme.palette.realm.reasonable, 0.2)
        }
      },
      '&.spacious': {
        backgroundColor: alpha(theme.palette.realm.spacious, 0.15),
        ...
        '&:hover': {
          backgroundColor: alpha(theme.palette.realm.spacious, 0.2)
        }
      },
      '&.golden': {
        backgroundColor: alpha(theme.palette.rarity.golden, 0.15)
      ...
      '&.partner': {
        ...
        '&:hover': {
          backgroundColor: alpha(theme.palette.realm.partner, 0.2)
        }
      },
      '&.realm-generic': {
    ...
    parcelName: {
      fontSize: 16,
      textShadow: `1px 1px 0px ${alpha('#000', 0.3)}`,
      whiteSpace: 'nowrap',
...
export const tooltipStyles = makeStyles((theme) =>
  createStyles({
    ...
    labelRarityColored: {
      ...
      '.humble &': {
        backgroundColor: lighten(theme.palette.realm.humble, 0.4),
        color: theme.palette.secondary.main
      },
      '.reasonable &': {
        backgroundColor: lighten(theme.palette.realm.reasonable, 0.4),
        color: theme.palette.secondary.main
      },
      '.spacious &': {
        backgroundColor: lighten(theme.palette.realm.spacious, 0.4),
        color: theme.palette.secondary.main
      },
      '.partner &': {
        backgroundColor: lighten(theme.palette.realm.partner, 0.4),
        color: theme.palette.secondary.main
      }
    },
    labelBalance: {
...
export const ERC1155InnerStyles = makeStyles((theme) =>
  createStyles({
    ...
    textHighlight: {
      ...
      '&.humble': {
        color: lighten(theme.palette.realm.humble, 0.3)
      },
      '&.reasonable': {
        color: lighten(theme.palette.realm.reasonable, 0.3)
      },
      '&.golden': {
        color: theme.palette.rarity.golden
      },
      '&.spacious': {
        color: lighten(theme.palette.realm.spacious, 0.3)
      },
      '&.partner': {
...
export const parselStyles = makeStyles((theme) =>
  createStyles({
    ...
    boost: {
      ...
      '&.fud': {
        backgroundColor: lighten(theme.palette.alchemica.fud, 0.3),
        borderColor: theme.palette.alchemica.fud
      },
      '&.fomo': {
        backgroundColor: lighten(theme.palette.alchemica.fomo, 0.3),
        borderColor: theme.palette.alchemica.fomo
      },
      '&.alpha': {
        backgroundColor: lighten(theme.palette.alchemica.alpha, 0.3),
        borderColor: theme.palette.alchemica.alpha
      },
      '&.kek': {
        backgroundColor: lighten(theme.palette.alchemica.kek, 0.3),
...
export const portalStyles = makeStyles(() =>
  createStyles({
    portalImage: {
      width: 100,
      maxWidth: 100,
...
export const channelingStyles = makeStyles(() =>
  createStyles({
    container: {
      position: 'absolute',
      bottom: 4,
