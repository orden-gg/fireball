...
import { AKEK_CONTRACT, ALPHA_CONTRACT, FOMO_CONTRACT, FUD_CONTRACT } from './common/constants';

const akekContract = ethersApi.makeContract(AKEK_CONTRACT, AKEK_ABI, 'polygon');
