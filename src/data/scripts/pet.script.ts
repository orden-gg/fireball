            ...
            axios
                ...
                .then(async res => {
                    ...
                    if (gasPriceGwei >= txCostLimit) {
                        ...
                        console.log(
                            `⌛ Next timer in minutes: ${paint(repeatTimer / 60 / 1000, CONSOLE_COLORS.Green)}`
                        );
                        return;
                    }
                    console.log(
                        `💱 tx cost: maximum - ${txCostLimit} current - ${paint(gasPriceGwei, CONSOLE_COLORS.Pink)}`
                    );
                    ...
                    if (!gotchis.length) {
                        ...
                        console.log(
                            `⌛ Next timer in minutes: ${paint((repeatTimer / 60 / 1000) * 12, CONSOLE_COLORS.Green)}`
                        );
                        return;
                    }
                    ...
                    MAIN_CONTRACT_WITH_SIGNER.interact(gotchiIds, {
                        ...
                        tx.wait()
                            .then(() => {
                                ...
                                console.log(
                                    `⌛ Next timer in minutes: ${paint(
                                        HALF_DAY_MILLIS / 60 / 1000 + 1,
