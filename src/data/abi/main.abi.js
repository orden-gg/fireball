export const MAIN_ABI = [
                        ...
                        components: [
                            ...
                            { internalType: 'uint256', name: 'itemId', type: 'uint256' },
                            {
                                components: [
                                    ...
                                    { internalType: 'uint32', name: 'totalQuantity', type: 'uint32' },
    ...
    { inputs: [{ internalType: 'uint256', name: '_tokenId', type: 'uint256' }], name: 'availableSkillPoints', outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }], stateMutability: 'view', type: 'function' },
    { inputs: [{ internalType: 'int16[6]', name: '_numericTraits', type: 'int16[6]' }], name: 'baseRarityScore', outputs: [{ internalType: 'uint256', name: 'rarityScore_', type: 'uint256' }], stateMutability: 'pure', type: 'function' },
    {
        inputs: [
            { internalType: 'uint256', name: '_tokenId', type: 'uint256' },
    ...
    },
    {
        ...
        name: 'currentHaunt',
        outputs: [
            { internalType: 'uint16', name: 'hauntId_', type: 'uint16' },
            {
                components: [
    ...
    { inputs: [{ internalType: 'uint256[]', name: '_tokenIds', type: 'uint256[]' }], name: 'interact', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    { inputs: [{ internalType: 'uint256', name: '_tokenId', type: 'uint256' }], name: 'kinship', outputs: [{ internalType: 'uint256', name: 'score_', type: 'uint256' }], stateMutability: 'view', type: 'function' },
    {
        inputs: [{ internalType: 'uint256', name: '_tokenId', type: 'uint256' }],
        ...
        outputs: [
            {
                components: [
                    ...
                    {
                        components: [
                            { internalType: 'int16[6]', name: 'modifiers', type: 'int16[6]' },
                            { internalType: 'bytes3', name: 'primaryColor', type: 'bytes3' },
                            { internalType: 'bytes3', name: 'secondaryColor', type: 'bytes3' },
    ...
    { anonymous: false, inputs: [{ indexed: false, internalType: 'uint256', name: 'listingFeeInWei', type: 'uint256' }], name: 'ChangedListingFee', type: 'event' },
    {
        ...
        inputs: [
            ...
            { indexed: false, internalType: 'address', name: 'erc1155TokenAddress', type: 'address' },
            { indexed: false, internalType: 'uint256', name: 'erc1155TypeId', type: 'uint256' },
        ...
        outputs: [
            {
                components: [
                    ...
                    { internalType: 'address', name: 'erc1155TokenAddress', type: 'address' },
        ...
        outputs: [
            {
                components: [
                    { internalType: 'uint256', name: 'listingId', type: 'uint256' },
                    { internalType: 'address', name: 'seller', type: 'address' },
                    { internalType: 'address', name: 'erc721TokenAddress', type: 'address' },
    ...
    { inputs: [{ internalType: 'uint256', name: '_tokenId', type: 'uint256' }], name: 'portalAavegotchisSvg', outputs: [{ internalType: 'string[10]', name: 'svg_', type: 'string[10]' }], stateMutability: 'view', type: 'function' },
    {
        inputs: [
            { internalType: 'string', name: '_svg', type: 'string' },
            {
    ...
    { inputs: [], name: 'linkBalance', outputs: [{ internalType: 'uint256', name: 'linkBalance_', type: 'uint256' }], stateMutability: 'view', type: 'function' },
    { inputs: [{ internalType: 'uint256[]', name: '_tokenIds', type: 'uint256[]' }], name: 'openPortals', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    {
        inputs: [
